...
<body style="background-color: #161E23; color: aliceblue;">
  ...
  <main class="align-middle align-middle mt-5">
    <div class="container">
      <a href="moduloConta.html"><button id="buttonVoltar"><i class="fa-solid fa-arrow-left-long"></i> Voltar</button></a>
    </div>
</body>
<?php
...
if($saldo >= $valorSaque){
    ...
    echo "<script> alert('Valor de saque deve ser menor que saldo!') </script>";
    exit;
}
