...
<body style="background-color: #161E23; color: aliceblue;">
  ...
  <main class="align-middle align-middle mt-5">
    <div class="container">
        ...
        function deletar(id, tipo_chave){
        var resultado = confirm("Deseja remover a chave " +  tipo_chave);
        if(resultado == true){
            var url = "processarRemocaoChavePix.php?id=" + id;
        ...
        while($linha = mysqli_fetch_array($tabela)){       
            ...
            onclick='deletar(" . $linha['id'] . ", \"" . $linha['tipo_chave'] . "\")' />";
            echo "</td>";
        ...
        echo "</table>";
        mysqli_close($conn);
        echo "<button class='button-cadastar-chave' data-bs-toggle='modal' data-bs-target='#chavesPixModal'><i class='fa-solid fa-plus'></i> Cadastrar nova chave</button>";
    ...
    <div class="modal-content">
      ...
      <form id="addChaveForm" action="processaAdicaoChavePix.php" method="post">
      <div class="modal-body">
        <div class="mb-3">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="tipoChave" id="inlineRadio1" value="1" checked>
                <label class="form-check-label" for="inlineRadio1">Telefone</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="tipoChave" id="inlineRadio2" value="2">
